  ...
  "recordings": [
    {
      ...
      "price": "0.0025",
      "price_unit": "USD",
      "media_url": "https://api.unpod.ai/v1/Recordings/RE1234567890abcdef1234567890abcdef/Media",
...
| 503         | media_unavailable    | No healthy media backend could serve the call; the session is finalized `failed` with `end_reason="media_unavailable"` |
