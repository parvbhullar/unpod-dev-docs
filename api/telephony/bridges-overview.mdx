...
<Frame>
  <img src="/images/diagrams/bridge-lifecycle.svg" alt="Animated bridge lifecycle diagram showing bridge creation in draft, provider connection, number assignment, active state, and deletion." />
</Frame>
