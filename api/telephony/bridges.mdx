...
BASE_URL = 'https://unpod.ai/api/v2/platform/telephony/bridges'
...
# Get bridge by slug
curl -X GET "https://unpod.ai/api/v2/platform/telephony/bridges/sales-bridge-abc123/" \
  -H "Authorization: Token your-api-token" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id"

# Update a bridge
curl -X PATCH "https://unpod.ai/api/v2/platform/telephony/bridges/sales-bridge-abc123/" \
  -H "Authorization: Token your-api-token" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id" \
  -H "Content-Type: application/json" \
...
# Delete a bridge
curl -X DELETE "https://unpod.ai/api/v2/platform/telephony/bridges/support-bridge-xyz789/" \
  -H "Authorization: Token your-api-token" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id"

# Connect provider to bridge
curl -X POST "https://unpod.ai/api/v2/platform/telephony/bridges/sales-bridge-abc123/connect-provider/" \
  -H "Authorization: Token your-api-token" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id" \
  -H "Content-Type: application/json" \
...
# Disconnect provider from bridge
curl -X POST "https://unpod.ai/api/v2/platform/telephony/bridges/sales-bridge-abc123/disconnect-provider/" \
  -H "Authorization: Token your-api-token" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id" \
  -H "Content-Type: application/json" \
