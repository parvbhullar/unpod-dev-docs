...
<Note>
You can get the agent `handle` from the [Get All Agents](/api/execution/tasks#get-all-agents) endpoint above or from the **Space** tab under [Get All Organizations](/api/space/spaces#get-all-organizations).
</Note>
