...
<Frame>
  <img src="/images/diagrams/platform-execution-lifecycle.svg" alt="Animated platform execution lifecycle diagram showing task creation, pending state, execution, and completed or failed outcomes." />
</Frame>
