...
Create one or more Voice AI call tasks for a batch of contacts.
...
```http
POST /api/v2/platform/spaces/8KZAMRAHSXXXXXXMAYNASMJC/tasks/create/
Headers:
  ...
  "documents": [
    {
      ...
      "labels": ["Interested"],
      "title": "Lead Document",
      "description": "Sales lead from Q1",
