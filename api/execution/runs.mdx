...
```bash cURL
# Get all runs in a space
curl -X GET "https://unpod.ai/api/v2/platform/spaces/your-space-token/runs/" \
  -H "Authorization: Token your-api-token" \
  -H "Content-Type: application/json"

# Get tasks for a specific run
curl -X GET "https://unpod.ai/api/v2/platform/spaces/your-space-token/runs/R40fe5eface1511f082ac156368e7acc4/tasks/" \
  -H "Authorization: Token your-api-token" \
  -H "Content-Type: application/json"
```
