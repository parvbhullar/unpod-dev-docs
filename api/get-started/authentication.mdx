...
## How to Get Your Org-Handle

The Org-Handle is your organization's unique domain identifier:

1. **Login** to the [Unpod Dashboard](https://unpod.dev/)
2. Your Org-Handle is visible in the URL or organization settings
3. It's typically your organization's subdomain (e.g., `your-company`)
