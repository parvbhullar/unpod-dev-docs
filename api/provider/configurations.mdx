...
BASE_URL = 'https://unpod.ai/api/v2/platform/telephony/providers-configurations'
...
# Get a specific configuration
curl -X GET "https://unpod.ai/api/v2/platform/telephony/providers-configurations/1/" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id"

# Update a configuration
curl -X PATCH "https://unpod.ai/api/v2/platform/telephony/providers-configurations/1/" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id" \
  -H "Content-Type: application/json" \
  -d '{
...
# Delete a configuration
curl -X DELETE "https://unpod.ai/api/v2/platform/telephony/providers-configurations/1/" \
  -H "Org-Handle: your-org-handle" \
  -H "Product-ID: your-product-id"
```
