...
Partially update a provider configuration by its ID. Only include the fields you want to change.
...
```http
PATCH /api/v2/platform/telephony/providers-configurations/42/
Headers:
...
```json
{
  ...
  "errors": "Invalid auth_token value"
}
```
