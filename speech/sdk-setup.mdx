...
AgentRunner(
    ...
    max_concurrent_calls: int = 50,      # capacity cap
...
|---|---|
| `max_concurrent_calls` | Max simultaneous calls this runner accepts. The orchestrator will not dispatch beyond this. |
...
| `capacity` | `int` | `max_concurrent_calls` setting |
