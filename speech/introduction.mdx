...
<CardGroup cols={2}>
  ...
  <Card title="Speech Pipe" icon="bot" href="/speech/pipes">
    Configure your agent's identity, voice profile, recording settings, and connection attachments.
  </Card>
...
|---|---|
| Handle phone calls | [Telephony Quickstart](/speech/quickstart) - provision a number and attach it to your agent |
