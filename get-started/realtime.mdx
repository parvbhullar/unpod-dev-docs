...
<CardGroup cols={2}>
  ...
  <Card title="Agents and voices" icon="workflow" href="/speech-stack/agents">
    The primary SDK surface: one `agent_id`, one brain, one or more voices.
  </Card>
  <Card title="Bring your agent" icon="bot" href="/speech-stack/bring-your-agent">
    Plug in LangChain, OpenAI, Anthropic, HTTP, or custom Python logic.
  </Card>
</CardGroup>
