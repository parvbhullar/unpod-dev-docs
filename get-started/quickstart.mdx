...
title: 'Quickstart'
icon: 'play'
description: 'The fastest way to hear a Voice Agent - talk to it in the browser in about 5 minutes. No phone number needed.'
---

<Note>
Integrating Unpod into your own stack instead? Go to
[SLM inference](/get-started/slm-inference) or
[STS inference](/get-started/sts-inference).
</Note>
