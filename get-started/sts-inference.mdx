---
title: 'Use as STS inference'
icon: 'audio-waveform'
description: 'Speech in, speech out, brain included. One WebSocket session.'
---

The full speech loop - STT, VAD, barge-in, TTS - plus the same playbook +
small model (or third-party model) brain, served as one realtime session.
Your app or telephony connects; Unpod runs the conversation.
