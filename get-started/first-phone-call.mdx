...
[Quickstart](/get-started/quickstart#step-2-set-your-environment).
...
[Trunks](/speech-stack/numbers#trunks) for both trunk types, or the
[Provisioning checklist](/speech-stack/setup-checklist) for the full production path.
