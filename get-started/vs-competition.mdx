---
title: 'Unpod vs Pipecat vs LiveKit'
icon: 'git-compare'
...
| **Your agent format** | Webhook, SDK, LangChain, MCP (preview) | LangChain, custom | LangChain, custom |
...
async def handle_call(ctx: CallContext) -> None:
    ctx.session.dialog_machine = DialogMachine("support.yaml", llm="anthropic/claude-haiku-4-5")
...
<Card title="Self-hosting Unpod" icon="server" href="/platform/self-hosting/quickstart">
