...
## Add a Phone Number <Badge variant="info">We can add video</Badge>
...
## Connect a Voice AI Provider <Badge variant="info">We can add video</Badge>
...
## Activate the Bridge <Badge variant="info">We can add video</Badge>
