...
anywhere, and shines on Unpod. It takes a prompt or a flow graph and turns it
into a running dialog state machine - managing turn-by-turn logic, tool calls,
flow transitions, and conversation memory.
...
<Note>
**Coming from the Speech Stack?** Assign a `DialogMachine` to
