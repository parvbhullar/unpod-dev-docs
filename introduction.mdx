...
| **Customer Support** | **Sales and Lead Qualification** | **Appointment Scheduling** |
|-----------------------|----------------------------------|-----------------------------|
| Automate inbound calls with agents and escalate to humans when needed. | Make outbound sales calls and schedule appointments with concerned person. | Handle booking details, and schedule appointments after confirming availability. |
