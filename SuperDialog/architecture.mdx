...
<Frame>
  <img src="/images/diagrams/superdialog-runtime.svg" alt="SuperDialog runtime diagram showing user text entering DialogMachine.turn, loading nodes, building prompts, calling the LLM, running tools, updating state, advancing edges, and returning a turn result to the host." />
</Frame>
