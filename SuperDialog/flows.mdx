...
<Frame>
  <img src="/images/diagrams/superdialog-flow-graph.png" alt="SuperDialog flow graph diagram showing states connected by conditional edges, including fallback and retry paths." />
</Frame>
