...
<Frame>
  <img src="/images/diagrams/superdialog-flow-graph.png" alt="Appointment-style SuperDialog flow graph showing greeting, detail collection, availability checks, confirmation, completion, missing information fallback, and retry paths." />
</Frame>
