...
The [Quickstart](/get-started/quickstart#set-your-environment) documents every
...
| `agent_secret` | When set, inbound bridge connections are HMAC-verified; without it the runner accepts unsigned connections (dev default). |
