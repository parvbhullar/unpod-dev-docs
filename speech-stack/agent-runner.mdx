...
([unpod-ai/unpod-python-sdk](https://github.com/unpod-ai/unpod-python-sdk)):

```bash
uv add "unpod @ git+https://github.com/unpod-ai/unpod-python-sdk"
# optional: superdialog for structured flows
uv add "unpod[dialog] @ git+https://github.com/unpod-ai/unpod-python-sdk"
# optional: LangChain adapter
uv add "unpod[langchain] @ git+https://github.com/unpod-ai/unpod-python-sdk"
```
