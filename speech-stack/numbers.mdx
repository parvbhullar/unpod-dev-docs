...
dial; it rides on a [trunk](#trunks) and routes to whatever
...
- **BYON (Bring Your Own Number)** - route numbers you already own from any provider over a [trunk](#trunks)
...
Full provisioning walk-through: [Make Your First Phone Call](/get-started/first-phone-call).
