...
see [Call Lifecycle](/speech/call-lifecycle).

---

## Related

- [Call Lifecycle](/speech/call-lifecycle) - end-to-end flow for both directions
- [Outbound Calls](/speech/outbound-calls) - the `calls.create()` API in detail
- [Hooks & Events](/speech/hooks-events) - every lifecycle event you can hook
- [Session Controls](/speech/session-controls) - ending and transferring live calls
