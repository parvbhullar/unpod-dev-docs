...
Alternatively, use the `HTTPAdapter` inside an `AgentRunner` entrypoint to call a remote endpoint from within the [SDK](https://github.com/unpod-ai/unpod-python-sdk):
