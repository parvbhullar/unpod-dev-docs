...
| Make a real SDK call fast | [Quickstart](/get-started/quickstart) - create an agent, attach a number, place an outbound call, and inspect the result |
| Connect both | Start with telephony, then add browser/app sessions - same agent, two entry points |
