...
<Warning>
Deleting a trunk removes its bindings. [Detach any mapped numbers](/connectivity/trunks/detach-numbers)
...
```bash cURL
curl -s -X DELETE "https://qa3.unpod.tv/api/v2/platform/telephony/trunks/21/" \
