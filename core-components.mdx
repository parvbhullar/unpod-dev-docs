...
<Frame>
  <img src="/images/diagrams/core-component-data-flow.png" alt="Core component data flow diagram showing a Number routed through a Bridge to Agent 1 or Agent 2, then through a Provider to an Endpoint." />
</Frame>
