...
<Card title="Full Chat API reference" icon="terminal" href="/playbook/api">
  Headers, request body, stateful sessions via `user`, and cURL / Python /
  JavaScript / Go examples.
</Card>
