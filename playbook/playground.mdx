...
hears.** How that seam is wired:
[SuperDialog on Unpod voice](/superdialog/embedding-guides/unpod-voice).
...
| **A developer** who wants to call the agent from code | [Chat API](/playbook/api) - the OpenAI-compatible endpoint |
