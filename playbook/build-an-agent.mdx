...
left-hand chat and it authors the playbook live into the **Editor** tab on the
right - refine it in chat or edit it by hand. Full tour of the screen:
[The Playground](/playbook/playground).
...
scripting every sentence fights the model instead of steering it. Why that
works: [Thinking in playbooks](/superdialog/thinking-in-playbooks).
</Tip>
...
Outcome-shaped checkpoints and slots in depth:
